    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Inicio',
            'icon' => 'ti ti-home',
            'url' => '/home' #esta es la ruta configurada en el archivo routes/web.php
        ],
        [
            'text' => 'Productos',
            'icon' => 'ti ti-shopping-cart', #este icono lo cambiamos https://themify.me/themify-icons
            'url' => '/products' #esta es la ruta configurada en el archivo routes/web.php
        ],
        [
            'text' => 'Soporte',
            'url' => '/support',
